...
class  HomePage(PageBase):
    ...
    def ust_menu_isimlerini_liste_ver(self):
        return self.webelement_listesinden_string_listesi_ver(HomePage.UST_MENU_LINKLERI)

    def ilk_urun_ismini_ver(self):
        ilk_urun_linki = self.driver.find_element(*HomePage.ILK_URUN_ISMI)
        return ilk_urun_linki.text

    def ilk_urun_fiyatini_ver(self):
        return self.driver.find_element(*HomePage.ILK_URUN_FIYATI).text
